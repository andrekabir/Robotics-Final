...
class ParticleFilter:
    ...
    def __init__(self):
        ...
        self.particles_pub = rospy.Publisher("tom/particle_cloud", PoseArray, queue_size=10)

        # publish the estimated robot pose
        self.robot_estimate_pub = rospy.Publisher("tom/estimated_robot_pose", PoseStamped, queue_size=10)
    ...
    def update_estimated_robot_pose(self):
        ...
        tom_pose.p = avgPoint
        tom_pose.q = avgQuat
        self.tom_estimated_pose_pub.publish(tom_pose)
    ...
    def jerry_pose_recieved(self, msg1):
        jerry_pose = Pose(msg1.p, msg1.q)
        self.jerry_pose = jerry_pose
        print(jerry_pose)
